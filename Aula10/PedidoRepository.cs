...
class PedidoRepository
{
    ...
    public Pedido Save(Pedido pedido)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "INSERT INTO Pedidos VALUES($pedidoid, $empregadoid, $datapedido)";
    ...
    public bool ExitsById(int pedidoid)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "SELECT count(id) FROM Pedidos WHERE (pedidoid = $pedidoid)";
